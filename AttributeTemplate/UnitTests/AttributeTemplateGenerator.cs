...
""";
    ...
    private static void Run(
        ...
        => Helpers.RunGenerator(_generator, targetSource, generatedSources, null, _header);

    private static void Run(
        [StringSyntax("C#")] string targetSource,
        GeneratedSource[] generatedSources,
        string[] errorIds)
        => Helpers.RunGenerator(_generator, targetSource, generatedSources, errorIds, _header);
