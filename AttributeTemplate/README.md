...
**Complete INotifyPropertyChanged implementation:**

```csharp
using AttributeTemplateGenerator;

// Class-level attribute generates infrastructure
...
// Property-level attribute generates getters and setters
...
class NotifyPropertyAttribute() : TemplateAttribute(
    ...
    """,
    Parent($"""
    private static readonly PropertyChangedEventArgs {Name}PropertyChangedEventArgs = new(nameof({Name}));
    """)
);
...
partial class Person {
    private static readonly System.ComponentModel.PropertyChangedEventArgs NamePropertyChangedEventArgs = new(nameof(Name));
